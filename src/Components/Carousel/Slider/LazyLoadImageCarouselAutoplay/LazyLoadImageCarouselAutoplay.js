...
function Slide(props) {
    ...
    return(
        <div className="slide image-slide boxshadow image-autoplay-carousel lazyload-blur lazyload-image-carousel-autoplay-container" style={{height: 300, width: `100%`}}>
            <div className="slide-div-background-image-full" style={{width: `100%`, height: `100%`, backgroundImage: `url('${image}')`}}>
                {/* shine div */}
...
class LazyLoadImageCarouselAutoplay extends Component {
    constructor(props) {
        super(props);
...
export default LazyLoadImageCarouselAutoplay;